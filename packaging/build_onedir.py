...
_BUNDLE_DATA: list[tuple[str, str]] = [
    ...
    (
        "modules/documents/postgres/migrations/0003_grant_history_select.sql",
        "modules/documents/postgres/migrations",
    ),
    (
        "modules/documents/postgres/provision_documents_schema.sql",
        "modules/documents/postgres",
    ),
    ...
    (
        "modules/registry/postgres/migrations/0001_initial.sql",
        "modules/registry/postgres/migrations",
    ),
    (
        "modules/registry/postgres/migrations/0002_grant_history_select.sql",
        "modules/registry/postgres/migrations",
    ),
    (
        "modules/registry/postgres/provision_registry_schema.sql",
        "modules/registry/postgres",
    ),
    ...
    (
        "modules/signature/postgres/provision_signature_schema.sql",
        "modules/signature/postgres",
    ),
    ...
    (
        "qm_platform/persistence/postgres/migrations/0006_blob_backup_set_org_fk.sql",
        "qm_platform/persistence/postgres/migrations",
    ),
    (
