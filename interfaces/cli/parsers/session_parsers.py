...
def register_session_parsers(sub: argparse._SubParsersAction) -> None:
    ...
    license_parser.add_argument("--module", default=None, help="Optional module tag to check (e.g. training)")
    license_parser.add_argument("--verbose", action="store_true", help="Print full license diagnostics JSON")
