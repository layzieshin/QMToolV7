"""Guarded Slot-2 restore drill for OPS00-C sealed backup sets."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="OPS00 guarded Slot-2 restore drill")
    ...
    home = runtime_home()
    destination_blob_root = resolve_home_path(home, "storage/platform/blobs-restore-drill")
    ...
    try:
        ...
        result = restore_backup_set(
            ...
            app_home=home,
            cleanup_target_database=True,
        )
    except (BackupOrchestratorError, DestructivePostgresGuardError) as exc:
