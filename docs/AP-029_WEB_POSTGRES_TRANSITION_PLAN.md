...
| OPS00 | Windows service, HTTPS, backup/restore, export | IN_PROGRESS | 756160c6e388b43afe3ef985cbe3d34767e6b0ef | evidence `build/ap-029-ops00/`; OPS00-A uninstalled service host in progress | authorized via `/execute-work-package OPS00`; Current checkpoint |
