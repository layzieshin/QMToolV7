...
- **Ergebnis:** `PASS` on frozen `runtime_test_candidate_sha`
  ...
  `docs_closeout_sha` is the post-merge docs-only commit and is not a runtime SHA. PR #56 was
  squash-merged to `main` @ `cb6871ae726fbff28f6ed7140bff8a132efb412a`; pre-merge CI
  35690452617 (`quality-gates`, `postgres-usermanagement`) was SUCCESS and all 6/6 review
