...
| PG01 | Documents/Registry/Signature PostgreSQL migration | IN_PROGRESS | 47ba80cc16ce89db546617d36c4474df37e8b600 | PG01-A escalation PASS R3 agent `3332f504…`; evidence `build/ap-029-pg01/a/recovery-r3/` + R2; contract SHA256 `326C9DFA…`; reviewer 2/2 UNVERIFIED superseded by escalation | PG01-A internal PASS (schemas/contracts); parent PG01 IN_PROGRESS; B–E pending; CHECKPOINT_GIT human gate |
