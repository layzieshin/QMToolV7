...
| PG01 | Documents/Registry/Signature PostgreSQL migration | IN_PROGRESS | 47ba80cc16ce89db546617d36c4474df37e8b600 | A PASS @ `26ff630`; B PASS (HUMAN_GOVERNANCE_EXCEPTION) @ `ceff256`; C PASS (HUMAN_AUTHORIZED_RECOVERY HR2) @ `0afe12a`; D PASS (escalation CONTROL_PLANE_PINNED agent `6849e51b`) @ `41fc651`; E pending; evidence `build/ap-029-pg01/` | Current checkpoint: PG01; subcheckpoints A–E serial |
